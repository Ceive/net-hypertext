...
namespace Ceive\Net\Hypertext\Document {
	...
	/**
	 * Class Processor
	 * @package Ceive\Net\Hypertext\Document
	 */
	abstract class Processor implements ProcessorInterface{
		 ...
		 * @param \Ceive\Util\Buffer\BufferInterface|string|null $buffer
		 */
		...
		/**
		 * @param \Ceive\Util\Buffer\BufferInterface $buffer
		 */
		...
		/**
		 * @return string|\Ceive\Util\Buffer\BufferInterface|null
		 */
